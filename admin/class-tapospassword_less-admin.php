 ...
 * @subpackage Tapospassword_less/admin
 */
 ...
 */
class Tapospassword_less_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/tapospassword_less-admin.css', array(), $this->version, 'all' );
